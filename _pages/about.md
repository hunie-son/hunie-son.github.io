...
My research focuses on security threats in modern computing systems, including Intel and AMD platforms, as well as emerging AR/VR devices. <br/>My focus has three parts: <br/>(1) **Microarchitectural side-channel attacks** and **AI-driven mitigations**.<br/>(2) **Machine learning security**.<br/>(3) **Cryptographic systems (FHE)**.
